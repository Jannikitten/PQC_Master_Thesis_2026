#ifndef PQC_MASTER_THESIS_2026_UI_H
#define PQC_MASTER_THESIS_2026_UI_H
...
namespace Safira::UI {
    ...
    void DrawButtonImage(const std::shared_ptr<Image>& imageNormal,
        const std::shared_ptr<Image>& imageHovered, const std::shared_ptr<Image>& imagePressed,
...
#endif //PQC_MASTER_THESIS_2026_UI_H