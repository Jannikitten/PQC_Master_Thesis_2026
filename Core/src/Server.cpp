...
namespace Safira {
    ...
    void Server::KickClient(ClientID id) {
        ...
        // Do NOT call wolfSSL_shutdown here — RemoveClient does it.
        // Calling it twice sends two close_notify packets, and the second one
        // arrives after the session is freed, looking like a new connection.
        RemoveClient(id);
    }
